...
from xraygpt.models.token_subsystem import TokenSubsystem 
...
class Chat:
    def __init__(self, model, vis_processor, device='cuda:0'):
        ...
        self.token_subsystem = TokenSubsystem(model.llama_model.config.name_or_path) 
    ...
    def answer(self, conv, img_list, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9,
        ...
        output_text = self.token_subsystem.decode(output_token, add_special_tokens=False) 
    ...
    def get_context_emb(self, conv, img_list):
        ...
        for i, seg_t in enumerate(seg_tokens):
            tokens = self.token_subsystem.tokenizer.convert_ids_to_tokens(seg_t.squeeze().tolist())
